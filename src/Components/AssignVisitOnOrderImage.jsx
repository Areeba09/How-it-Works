...
import image1 from "./images/order-1.png";
import image2 from "./images/order-2.png";
import image3 from "./images/order-3.png";


function AssignVisitOnOrderImage() {
  return (
...
export default AssignVisitOnOrderImage;